        ...
        <div className="sub-box">
          ...
          <div className="container">
            ...
            <div className="steps-wrapper">
              ...
              <SingleStepService
                numero={5}
                titulo="Cumplimiento H&S"
                texto="Necesitarás cumplir con los requisitos de seguridad y medio ambiente"
                boton="Ver más"
              />
            </div>
          </div>
      ...
      <div className="platforms-section">
        ...
        <div className="platforms-boxes">
          <SinglePlatformBoxService
            tittle="SHIPSTA"
            text="Portal a través del cual se solicitan cotizaciones para rutas"
            buttonText="Ir a SHIPSTA"
            img="/assets/platforms-icons/Plataformas-Shipsta.png"
            imgAlt="SHIPSTA Logo"
            href=""
            contacts={contactsShipsta}
          />
          <SinglePlatformBoxService
            tittle="ISM"
          ...
          <SinglePlatformBoxService
            tittle="SRM"
            text="Plataforma utilizada para el pago, estado de cuenta, aprobación de pedidos y comprobantes de pago"
            buttonText="Ir a SRM"
            img="/assets/platforms-icons/Plataformas-GenericHolcim.png"
            imgAlt="SRM Logo"
            href="https://www.portaldirecta.com/b2b_hcm_la/b2b/init.do"
          />
        </div>
      </div>
