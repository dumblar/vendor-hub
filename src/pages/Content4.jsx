  ...
  <div>
        ...
        <div className="container">
          ...
          <div className="steps-wrapper">
            ...
            <SingleStepService
              ...
              boton="Ver la lista de requisitos"
            />
            <SingleStepService
              numero={6}
              titulo="SICOP"
              texto="Descripción del proceso (pendiente)"
              boton="Ir a la plataforma SICOP"
              icono={true}
    ...
    <div className="platforms-section">
      ...
      <div className="platforms-boxes">
        ...
        <SinglePlatformBoxService
          tittle="SRM"
          text="Accede a material de capacitación sobre nuestra plataforma SRM"
          buttonText="Ir a SRM"
          img="/assets/platforms-icons/Plataformas-GenericHolcim.png"
          imgAlt="DIRECTA Logo"
